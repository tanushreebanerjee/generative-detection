...
# TODO: Are these labels below correct for Waymo
LABEL_NAME2ID = {
    'Car': 0, 
    'Pedestrian': 1,
    'Cyclist': 2
...
# TODO: Are these dimensions below correct for Waymo
NUSC_IMG_WIDTH = 1600
NUSC_IMG_HEIGHT = 900

@DATASETS.register_module()
class WaymoCameraInstances(Dataset):
...
class WaymoBase(MMDetWaymoDataset):
    ...
    def __getitem__(self, idx):
        ...
        ret.cam_instances = WaymoCameraInstances(cam_instances=cam_instances, img_path=os.path.join(self.img_root, cam_name, img_file), patch_size=self.patch_size, cam2img=sample_img_info.cam2img)
        return ret
